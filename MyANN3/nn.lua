...
function nn.GetDecision(mymouse,myindex)

	local input1 = fun.GetClosestCheeseDistance(mymouse)
	local input2 = fun.GetClosestCatDistance(mymouse)
	local bias = 1 		-- bias
	...
	local H1SignalSum = input1 * mymouse.weights[1] + input2 * mymouse.weights[3] + bias * mymouse.weights[5]
	local H2SignalSum = input1 * mymouse.weights[2] + input2 * mymouse.weights[4] + bias * mymouse.weights[6]
	...
	O1SignalSum = H1Output * mymouse.weights[7] + H2Output * mymouse.weights[10] + bias * mymouse.weights[13]
	O2SignalSum = H1Output * mymouse.weights[8] + H2Output * mymouse.weights[11] + bias * mymouse.weights[14]
	O3SignalSum = H1Output * mymouse.weights[9] + H2Output * mymouse.weights[12] + bias * mymouse.weights[15]
...
--print(O1SignalSum,O2SignalSum,O3SignalSum)
	...
	mymouse.output1 = O1Output
	mymouse.output2 = O2Output
	mymouse.output3 = O3Output
